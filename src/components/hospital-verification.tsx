...
export default function HospitalVerification() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const requiredDocs: (keyof typeof files)[] = [
      "registration",
      "license",
      "accreditation",
      "tax",
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Register your hospital or blood bank facility
                </p>
              </div>
            </div>
          </div>
                  ...
                  {[
                    {
                      ...
                      desc: "Official registration document from health authority",
                    },
                    {
                      key: "license",
                      icon: "fa-file-contract",
                      color: "red",
                      title: "Blood Bank License *",
                      desc: "Valid license for blood collection and storage",
                    },
                    {
                      key: "accreditation",
                      icon: "fa-award",
                      ...
                      desc: "National or international healthcare accreditation",
                    },
                    {
                      key: "tax",
                      ...
                      desc: "Tax ID or business registration certificate",
                    },
                  ].map((doc) => (
                    <div key={doc.key} className="document-card p-4 rounded-lg">
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        >
                          <i
                            className={`fas ${doc.icon} text-${doc.color}-600`}
                          ></i>
                        </div>
                      ...
                      {files[doc.key as keyof typeof files].preview && (
                        <div className="mt-2 flex items-center justify-between p-3 bg-white rounded-lg border-2 border-green-200">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              removeFile(doc.key as keyof typeof files)
                            }
                ...
                <div className="space-y-4 max-w-2xl mx-auto">
                  ...
                  <div>
                    ...
                    <div className="upload-area p-4 rounded-lg text-center cursor-pointer">
                      ...
                      />
                      <label
                        htmlFor="contactIdUpload"
                        className="cursor-pointer"
                      >
                        <i className="fas fa-id-card text-3xl text-purple-600 mb-2"></i>
                        <p className="text-sm text-gray-600 font-medium">
                          Upload government ID or employee badge
                        </p>
                        <p className="text-xs text-gray-500 mt-1">
                          PDF, JPG, PNG (Max 5MB)
                        </p>
                  ...
                  <div>
                    ...
                    <div className="upload-area p-4 rounded-lg text-center cursor-pointer">
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          PDF (Max 5MB) - Must be on official letterhead
                        </p>
                      </label>
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700">
                          All documents must be current and valid. Expired or
                          fraudulent documents will result in immediate
                          rejection and may lead to legal action.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="terms" className="text-sm text-gray-600">
                      I certify that all information and documents provided are
                      authentic and accurate. I have the authority to represent
                      this organization.
                    </label>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    >
                      I consent to Rapid Rescuers storing and processing this
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label
                      ...
                      className="text-sm text-gray-600"
                    >
                      Our organization complies with all applicable healthcare
                      regulations, HIPAA requirements, and blood banking
                      standards.
                    </label>
                  </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="glass-card p-8 max-w-md w-full text-center animation-fade-in">
            ...
            <p className="text-gray-600 mb-4">
              Your hospital verification application has been submitted
              successfully.
            </p>
            ...
            <p className="text-sm text-gray-600 mb-6">
              ...
              <span className="text-purple-600 font-mono">{referenceId}</span>
            </p>
            <button
              onClick={closeModal}
              className="btn-primary py-3 px-8 rounded-lg font-semibold"
            >
              Return to Home
            </button>
          </div>
