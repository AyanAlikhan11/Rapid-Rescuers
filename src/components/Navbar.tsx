...
//   }
  ...
  return (
    <header className="backdrop-blur-xl bg-white/70 shadow-md sticky top-0 z-50">
      ...
      <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-red-600 to-red-400 
          ...
          <Link href="/" className="font-bold text-xl tracking-wide transition-all duration-300 
  ...
  {/* {user ? ( */}
    <button
      ...
      className="ml-2 px-4 py-2 rounded-lg bg-gray-100 text-gray-800 text-sm 
                 shadow-sm border border-gray-200 transition-all duration-300 
                 hover:bg-gray-200 hover:shadow-md hover:scale-105"
    >
      Logout
    </button>
  {/* ) : ( */}
