    ...
    try {
      ...
      await setDoc(
        userRef,
        {
          ...
          email: user.email ?? "",
          role: null, // force user to select role later
          provider: "google",
          createdAt: serverTimestamp(),
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-white px-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">Join the life-saving network</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 border border-gray-300 py-3 rounded-xl transition ${
              loading ? "opacity-60 cursor-not-allowed" : "hover:bg-gray-50 cursor-pointer"
            }`}
          >
